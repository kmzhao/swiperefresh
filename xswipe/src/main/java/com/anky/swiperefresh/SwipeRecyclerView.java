...
import com.anky.swiperefresh.touch.DefaultItemTouchHelper;
import com.anky.swiperefresh.touch.OnItemMoveListener;
import com.anky.swiperefresh.touch.OnItemMovementListener;
import com.anky.swiperefresh.touch.OnItemStateChangedListener;
import com.anky.swiperefresh.widget.DefaultLoadMoreView;
...
public class SwipeRecyclerView extends RecyclerView {
    ...
    private static class ItemClick implements SwipeItemClickListener {
        ...
        public ItemClick(SwipeRecyclerView recyclerView, SwipeItemClickListener callback) {
    ...
    private static class ItemLongClick implements SwipeItemLongClickListener {
        ...
        public ItemLongClick(SwipeRecyclerView recyclerView, SwipeItemLongClickListener callback) {
            this.mRecyclerView = recyclerView;
            this.mCallback = callback;
        }
    ...
    private static class MenuItemClick implements SwipeMenuItemClickListener {
        ...
        public MenuItemClick(SwipeRecyclerView recyclerView, SwipeMenuItemClickListener callback) {
            this.mRecyclerView = recyclerView;
            this.mCallback = callback;
        }
