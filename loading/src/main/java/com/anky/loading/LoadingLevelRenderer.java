...
class LoadingLevelRenderer extends LoadingRenderer{
    ...
    public LoadingLevelRenderer(Context context) {
        super(context);
        init(context);
        setupPaint();
    ...
    public static class Builder {
        ...
        public LoadingLevelRenderer build() {
            LoadingLevelRenderer loadingRenderer = new LoadingLevelRenderer(mContext);
